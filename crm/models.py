...
class Order(models.Model):
    order_dt = models.DateTimeField(auto_now=True, max_length=200, verbose_name='Время заявки')
...
class ComentCrm(models.Model):
    ...
    coment_dt = models.DateTimeField(auto_now=True, verbose_name='Дата создания комментария')
